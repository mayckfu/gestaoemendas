-- Function Update: Enhance synchronization logic for pendencies
...
-- Add Trigger for Despesas table synchronization
...
-- Execute logic for all existing emendas to retroactively correct pendencies state
UPDATE public.emendas SET id = id;
