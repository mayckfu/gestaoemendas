...
import { EmendaForm } from '@/features/emendas/components/EmendaForm'
import {
  Sheet,
  SheetContent,
  SheetHeader,
...
const EmendasListPage = () => {
  ...
  const handleExportDocx = async () => {
    ...
    const result = await exportToDocx(filteredAmendments)
        ...
        <div className="flex flex-col sm:flex-row flex-wrap items-center gap-3 w-full lg:w-auto">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            >
              ...
              <span className="sm:not-sr-only sm:whitespace-nowrap text-blue-600 dark:text-blue-400">Word</span>
            </Button>
            {canCreate && (
              <Button
                size="sm"
